import { Settings } from "js_api/js/settings.js";
export class Map {
    constructor(){
		this.materialArray;
    ...
    generation(scene) {
		...
		const materialArray = ["/js_api/img/dirt-side.jpg", "/js_api/img/dirt-side.jpg", "/js_api/img/dirt-top.jpg", "/js_api/img/dirt-bottom.jpg", "/js_api/img/dirt-side.jpg", "/js_api/img/dirt-side.jpg"].map(v => {
